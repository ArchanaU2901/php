...
.card:hover{
	border: 1px solid rgba(0,0,0,.125);
	box-shadow:0 0 12px solid black;
	height: 12em;
}
...
<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd; width:101%;" >
	<div class="container-fluid" >
	...
	<div class="row">
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px; margin: 0em 2em;">
		...
		<div class="col-md-3">
			<div class="card bg-light" style="width: 300px;  margin: 0em 1em;">
		...
		<div class="col-md-3">
		<div class="card bg-light" style="width: 300px; margin: 3em 2em;">
